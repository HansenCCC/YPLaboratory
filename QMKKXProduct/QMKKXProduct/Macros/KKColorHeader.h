...
//白色 ->
#define KKColor_FFFFFF CMCustomColor(@"FFFFFF")
#define KKColor_F3F4F6 CMCustomColor(@"F3F4F6")
#define KKColor_F0F0F0 CMCustomColor(@"F0F0F0")
#define KKColor_EEEEEE CMCustomColor(@"EEEEEE")
#define KKColor_DDE7F0 CMCustomColor(@"DDE7F0")
#define KKColor_999999 CMCustomColor(@"999999")
...
#define KKColor_000000 CMCustomColor(@"000000")
