//
//  KKWeChatImageListTableViewCell.h
//  QMKKXProduct
//
...
@interface KKWeChatImageListTableViewCell : UITableViewCell<UICollectionViewDelegate,UICollectionViewDataSource,TZImagePickerControllerDelegate>
//属性
...
AS_SINGLETON(KKWeChatImageListTableViewCell);
@end
